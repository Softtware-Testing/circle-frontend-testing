...
export function scenario_2() {
  ...
  group(
    "page_1 - http://localhost:3000/ -> logging into the site and changing lastname and DOB",
    function () {
      response = http.get("http://localhost:3000/", {});
      sleep(2.7);
      response = http.post(
      ...
      check(response, {
        "verify last name text": (r) => r.body.includes("Rauf2"),
      });
      check(response, {
...
export function scenario_3() {
  ...
  group(
    "page_1 - http://localhost:3000/ -> logging into the site and changing bio",
    function () {
      response = http.get("http://localhost:3000/", {
        headers: {
